...
| `autopull ` | (Optional, experimental) Check for changes from the repo on startup. If any are found, the script pull them & restarts itself. Setting it to any string enables it |
