...
argparse.add_argument("--host-domain", "-hd", help="Domain where your files will be hosted. E.g. https://example.com")
argparse.add_argument("--timezone", "-tz", default="Europe/London", help="What timezone to use for ics events")
argparse.add_argument("--title", help="What title to use for the html export")
...
if __name__ == "__main__":
    ...
    clone_or_pull_repo(parent_dir_path=str(cwd), dest_path="public")
